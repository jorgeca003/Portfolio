  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 text-gray-900 dark:text-white transition-colors">
      <div className="max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
                  Results-driven Software Engineer with 9 years of experience in software development, 
                  technical support, and test engineering for high-tech and semiconductor industries.
                </p>
        ...
        <section className="mb-16">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-gray-700">
            <h2 className="text-3xl font-bold mb-6 text-gray-900 dark:text-white">Skills</h2>
        ...
        <footer className="text-center text-gray-600 dark:text-gray-400 py-8">
          <p>&copy; {new Date().getFullYear()} Jorge Castro. All rights reserved.</p>
        </footer>
      </div>
    </div>
  )
